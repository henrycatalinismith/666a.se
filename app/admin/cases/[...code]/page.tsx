      ...
      <div className="container pt-8 flex flex-col gap-2">
        ...
        <Relations
          rows={[
...

            {
              ...
              href: `/admin/companies/${c.company?.code}`,
              text: 'Company',
...

            {
              ...
              href: `/admin/municipalities/${c.documents[0].municipality?.slug}`,
              text: 'Municipality',
...

            {
              ...
              href: `/admin/counties/${c.documents[0].county?.slug}`,
              text: 'County',
        ...
        <EntityList
          items={c.documents.map((document) => ({
            ...
            href: `/admin/documents/${document.code}`,
