...
ActiveRecord::Schema[7.1].define(version: 2024_06_15_200834) do
  ...
  create_table "labour_law_elements", id: :string, default: -> { "ULID()" }, force: :cascade do |t|
    ...
    t.index ["element_slug"], name: "index_labour_law_elements_on_element_slug"
  ...
  create_table "labour_law_sentences", id: :string, default: -> { "ULID()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "element_id"
    t.text "source_text"
  ...
  create_table "labour_law_words", id: :string, default: -> { "ULID()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "sentence_id"
    t.text "source_word"
    t.text "target_word"
    t.index ["sentence_id"], name: "index_labour_law_words_on_sentence_id"
  end
  ...
  add_foreign_key "labour_law_words", "labour_law_sentences", column: "sentence_id"
